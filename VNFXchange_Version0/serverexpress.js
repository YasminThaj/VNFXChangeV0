...
app.post('/vnfonboardimage',function(req,resp){
	console.log("gggggggggggggggggggggggggggggggg"+ req.param('vnftypeid'));
	var str='';
    ...
    var cmd = exec('python',["C:\\xampp\\htdocs\\VNFXchange\\launch_instances.py", arg1, arg2,arg3]);
 	console.log("cmd before------"+cmd)
	exec(cmd, function(error, stdout, stderr) {
    console.log("cmd after------"+cmd)	
    if (error) {
	...
	console.log("--------------------------scucess"); 
	VnfOnboardCollection.insert({VnfTypeId:VnfTypeId,VnfTypeName:VnfTypeName,
								 ImageId:imageId,ImageName:imageId,
